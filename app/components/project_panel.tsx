        ...
        <article className="mb-8 w-full rounded-2xl border border-[var(--pf-border-subtle)] bg-[var(--pf-bg-surface)] p-5 transition-[transform,border-color] duration-150 hover:-translate-y-0.5 hover:border-[var(--pf-border-strong)] md:p-8">
            <div>
                <div className="flex items-start justify-between gap-4">
                    ...
                    {projectUrl && <div className="shrink-0 rounded-sm border border-[var(--pf-success)] px-2 py-1 font-mono text-[0.7rem] font-bold uppercase tracking-[.08em] text-[var(--pf-success)]">● Public</div>}
                    {!projectUrl && <div className="shrink-0 rounded-sm border border-[var(--pf-danger)] px-2 py-1 font-mono text-[0.7rem] font-bold uppercase tracking-[.08em] text-[var(--pf-danger)]">● Private</div>}
                </div>
